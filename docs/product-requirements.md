...
_Status: Phase 0 (Research & Planning) draft. Source spec: [`project_prompt.txt`](../project_prompt.txt). Evidence backing: [`docs/evidence-review.md`](./evidence-review.md) / [`data/evidence-registry.json`](../data/evidence-registry.json)._
